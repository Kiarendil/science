...
f = ROOT.TFile('../data/B_cut_.root', 'read')  # file where to read from
...
_PicName = '../pictures/B_mass_Fit.png'  # name of file with picture

# start positions for fit
fit_M0 = 5.27963
fit_Sigma0 = 0.015
fit_N0 = 1364
...
# if TwoGaus:
#     pdfSum.plotOn(mframe, ROOT.RooFit().Components('pdfS2'), ROOT.RooFit().LineColor(ROOT.kGreen), ROOT.RooFit().LineWidth(1))
